...
public class Money {
    ...
    /**
     * Constructor creates a Money object using the parameter money object to make a
     * duplicate money object, by copying the value of each instance variable from
     * the parameter object to the instance variable of the new object
     * 
     * @param otherObject the parameter money object to make a duplicate money
     *                    object
     */
    ...
    /**
     * The equals method compares the instance variables of the calling object with
     * instance variables of the parameter object for equality
     * 
     * @param otherObject the parameter object to compare with the calling object
     * @return true if the dollars and the cents of the calling object are
     *         the same as the dollars and the cents of the parameter object.
    ...
    /**
     * toString method returns a String that looks like money, including the dollar
     * sign
     * 
     * @return a money String looks like $dolars.cents
     */
